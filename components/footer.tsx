...
export function FooterIcon({ Icon, Link }) {
    return (
        <a
            href={Link}
...
export default function Footer() {
    return (
        <div className="mt-6 tablet:m-0 flex justify-center relative z-0 min-h-[60px] bottom-0 left-0 right-0 w-full items-center">
            <FooterIcon
                Link="mailto:pranjalg1122@gmail.com"
                Icon={Mail}
            ></FooterIcon>
            <FooterIcon Link="/" Icon={Tool}></FooterIcon>
            <FooterIcon
