...
export default function Navbar() {
  return (
    <nav className="flex justify-center w-full fixed top-0 z-10 backdrop-blur-sm">
      <div className="flex flex-row items-center md:gap-8 gap-4 md:text-base text-sm  w-full max-w-3xl px-auto py-1 md:px-0 px-2">
        <Link href="#home" className={variants({ variant: "navbarLink" })}>
          home
        </Link>
